...
Elm.CharacterModel = Elm.CharacterModel || {};
Elm.CharacterModel.make = function (_elm) {
   "use strict";
   _elm.CharacterModel = _elm.CharacterModel || {};
   if (_elm.CharacterModel.values)
   return _elm.CharacterModel.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "CharacterModel",
   $Basics = Elm.Basics.make(_elm),
   ...
   var pinyinSyllables = $List.reverse(A2($List.sortBy,
   $String.length,
   _L.fromArray(["a"
                ,"o"
                ,"e"
                ...
                ,"xuan"
                ,"xun"])));
   var pinyinVowels = _L.fromArray(["a*"
                                   ,"o*"
                                   ,"e*"
                                   ,"i*"
                                   ,"er"
                                   ...
                                   ,"i*"
                                   ,"ü*"]);
   var vowelToTonesMap = $Dict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                      ,_0: "a"
                                                      ,_1: "aāáǎà"}
                                                     ,{ctor: "_Tuple2"
                                                      ,_0: "e"
                                                     ...
                                                     ,{ctor: "_Tuple2"
                                                      ,_0: "Ü"
                                                      ,_1: "ÜǕǗǙǛ"}]));
   var resolveMaybe = F2(function ($default,
   maybe) {
      return function () {
         switch (maybe.ctor)
   ...
   var getDefaultToKey = F2(function (key,
   dict) {
      return A2(resolveMaybe,
      key,
      A2($Dict.get,key,dict));
   });
   var pinyinToRegex = F2(function (s,
   i) {
      return function () {
         var vowel = A3($String.slice,
         i,
         i + 1,
         s);
         var lookupValue = A2(getDefaultToKey,
         vowel,
         vowelToTonesMap);
         var rightStr = A2($String.dropLeft,
         i + 1,
         s);
         var leftStr = A2($String.left,
         i,
         s);
   ...
   var foldPinyinVowels = F2(function (pinyin,
   dict) {
      return function () {
         var key = A2($String.filter,
         function (c) {
            return !_U.eq(c,_U.chr("*"));
         },
         pinyin);
         var pinyinIndex = A2(resolveMaybe,
         1,
         $List.head(A2($String.indexes,
         "*",
         pinyin))) - 1;
   ...
   var pinyinVowelsToRegex = A3($List.foldr,
   foldPinyinVowels,
   $Dict.empty,
   pinyinVowels);
   var pinyinSyllableToRegexString = function (pinyin) {
      return function () {
         var vowel = A2($String.filter,
         function (c) {
         ...
         pinyin);
         var vowelRegex = A2(getDefaultToKey,
         vowel,
         pinyinVowelsToRegex);
   ...
   var foldPinyinSyllables = F2(function (pinyin,
   l) {
      return A2($List.append,
      _L.fromArray([pinyinSyllableToRegexString(pinyin)]),
      l);
   });
   var stringRegex = A2($String.join,
   "|",
   A2($List.append,
   _L.fromArray(["[,.?! ]"]),
   A3($List.foldr,
   ...
   _L.fromArray([]),
   pinyinSyllables)));
   var pinyinRegex = $Regex.caseInsensitive($Regex.regex(stringRegex));
   var tokenizePinyin = function (s) {
   ...
   var characterModel = F2(function (chinese,
   pinyin) {
      return {_: {}
             ,answers: _L.fromArray([])
             ,chinese: chinese
             ,currentAnswer: $Maybe.Nothing
             ,pinyin: A2($Regex.contains,
             $Regex.regex("[,.?!]"),
             pinyin) ? $Maybe.Nothing : $Maybe.Just(pinyin)
             ,selected: false};
   });
   var sentenceModel = function (sentence) {
      return A3($List.map2,
      characterModel,
      A2($String.split,
      "",
      sentence.chinese),
      tokenizePinyin(sentence.pinyin));
   };
   var workbookProblemToSentence = function (wp) {
      return {_: {}
             ,chinese: wp.chinese
             ,pinyin: wp.pinyin};
   };
   var inputToPinyin = function (input) {
      return function () {
         var regexString = pinyinSyllableToRegexString(A4($Regex.replace,
         $Regex.AtMost(1),
         $Regex.regex("[0-9]$"),
         function (_v4) {
            return function () {
         ...
         input));
         var n = function () {
            var _v6 = $String.toInt(A2($String.right,
            1,
            input));
            switch (_v6.ctor)
            {case "Err": return -1;
               case "Ok": return _v6._0;}
            _U.badCase($moduleName,
            "between lines 52 and 55");
         }();
         return _U.cmp(n,
         0) < 0 || _U.cmp(n,
         4) > 0 ? input : A4($Regex.replace,
         $Regex.AtMost(1),
         $Regex.regex("\\[.*\\]"),
         function (match) {
   ...
   var DoNotGrade = {ctor: "DoNotGrade"};
   var NotGraded = {ctor: "NotGraded"};
   var Incorrect = {ctor: "Incorrect"};
   var Correct = {ctor: "Correct"};
   var grade = function (characterModel) {
      return function () {
         var _v9 = characterModel.pinyin;
         switch (_v9.ctor)
         {case "Just":
            return function () {
                 var _v11 = $List.head(characterModel.answers);
                 switch (_v11.ctor)
                 {case "Just":
                    return _U.eq($String.toLower(_v9._0),
                      $String.toLower(inputToPinyin(_v11._0))) ? Correct : Incorrect;
                    case "Nothing":
                    return NotGraded;}
                 _U.badCase($moduleName,
   ...
   var WorkbookProblem = F4(function (a,
   b,
   c,
   d) {
      return {_: {}
   ...
   var workbookDecoder = $Json$Decode.list(A5($Json$Decode.object4,
   WorkbookProblem,
   A2($Json$Decode._op[":="],
   "chinese",
   $Json$Decode.string),
   ...
   "book",
   $Json$Decode.$int)));
   var CharacterModel = F5(function (a,
   b,
   c,
   d,
   e) {
   ...
   var Sentence = F2(function (a,
   b) {
      return {_: {}
             ,chinese: a
             ,pinyin: b};
   });
   _elm.CharacterModel.values = {_op: _op
                                ,characterModel: characterModel
                                ,sentenceModel: sentenceModel
                                ,tokenizePinyin: tokenizePinyin
                                ,workbookDecoder: workbookDecoder
                                ,workbookProblemToSentence: workbookProblemToSentence
                                ,grade: grade
                                ,inputToPinyin: inputToPinyin
                                ,CharacterModel: CharacterModel
                                ,Sentence: Sentence
...
Elm.ListUtils.make = function (_elm) {
   ...
   var find = F2(function (p,l) {
      return A3($List.foldl,
      F2(function (a,b) {
         return function () {
            switch (b.ctor)
            {case "Just":
               return $Maybe.Just(b._0);
               case "Nothing":
               return p(a) ? $Maybe.Just(a) : $Maybe.Nothing;}
            _U.badCase($moduleName,
...
Elm.LocalStorage.make = function (_elm) {
   ...
   if (_elm.LocalStorage.values)
   return _elm.LocalStorage.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var remove = function (key) {
      return $Native$LocalStorage.remove;
   };
   ...
   str) {
      return function () {
         ...
         switch (_v0.ctor)
         {case "Err":
            return $Task.fail(UnexpectedPayload(_v0._0));
            case "Ok":
            return $Task.succeed($Maybe.Just(_v0._0));}
         _U.badCase($moduleName,
   ...
   var NoStorage = {ctor: "NoStorage"};
   _elm.LocalStorage.values = {_op: _op
                              ,get: get
                              ,set: set
                              ,remove: remove
                              ,getJson: getJson
...
Elm.PinyinApp.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $CharacterModel = Elm.CharacterModel.make(_elm),
   ...
   $Regex = Elm.Regex.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Results = Elm.Results.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $StartApp = Elm.StartApp.make(_elm),
   $Task = Elm.Task.make(_elm),
   $Time = Elm.Time.make(_elm),
   $Window = Elm.Window.make(_elm),
   $WorkbookProblems = Elm.WorkbookProblems.make(_elm);
   var characterView = function (cm) {
      return function () {
         var pinyin = $Basics.not($List.isEmpty(cm.answers)) ? function () {
            var _v0 = cm.pinyin;
            switch (_v0.ctor)
            {case "Just": return _v0._0;
               case "Nothing": return "";}
         ...
         var className = function () {
            var _v2 = $CharacterModel.grade(cm);
            switch (_v2.ctor)
            {case "Correct":
               return "correct";
               case "DoNotGrade":
         ...
         var classList = cm.selected ? _L.fromArray([{ctor: "_Tuple2"
                                                     ,_0: className
                                                     ,_1: true}
                                                    ,{ctor: "_Tuple2"
                                                     ,_0: "selected"
                                                     ,_1: true}]) : _L.fromArray([{ctor: "_Tuple2"
                                                                                  ,_0: className
                                                                                  ,_1: true}]);
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("characterView")]),
         _L.fromArray([A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("pinyin")]),
                      _L.fromArray([$Html.text(pinyin)]))
                      ,A2($Html.div,
                      _L.fromArray([$Html$Attributes.classList(classList)]),
                      _L.fromArray([$Html.text(cm.chinese)]))]));
      }();
   };
   var sentenceView = F2(function (address,
   model) {
      return $Html.div(_L.fromArray([$Html$Attributes.$class("sentenceView")]))(A2($List.map,
      characterView,
      model));
   });
   var debugView = F2(function (address,
   model) {
      return function () {
         var lesson = model.lesson;
         var currentSentence = function () {
            var _v3 = lesson.currentSentence;
            switch (_v3.ctor)
            {case "Just": return _v3._0;
               case "Nothing":
               return _L.fromArray([]);}
            _U.badCase($moduleName,
            "between lines 272 and 275");
         }();
         return A2($Html.div,
         _L.fromArray([]),
         _L.fromArray([$Html.text($Basics.toString({ctor: "_Tuple3"
                                                   ,_0: A3($Results.shouldReviewSentence,
                                                   currentSentence,
                                                   model.results,
   ...
   var updateInput = F2(function (input,
   sentence) {
      return function () {
         var h = $List.head(sentence);
         return function () {
            switch (h.ctor)
            {case "Just":
               return h._0.selected ? A2($List._op["::"],
                 _U.replace([["currentAnswer"
                             ,$Maybe.Just(input)]],
                 h._0),
                 $ListUtils.forceTail(sentence)) : A2($List._op["::"],
                 h._0,
                 A2(updateInput,
                 input,
                 $ListUtils.forceTail(sentence)));
               case "Nothing":
               return _L.fromArray([]);}
            _U.badCase($moduleName,
            "between lines 239 and 244");
         }();
      }();
   });
   var updateCurrentSentence = F2(function (input,
   sentence) {
      return function () {
         switch (sentence.ctor)
         {case "Just":
            return $Maybe.Just(A2(updateInput,
              input,
              sentence._0));
            case "Nothing":
            return $Maybe.Nothing;}
   ...
   var updateInputPinyin = F2(function (input,
   model) {
      return function () {
         var lesson = model.lesson;
         return {_: {}
                ,lesson: _U.replace([["currentSentence"
                                     ,A2(updateCurrentSentence,
                                     input,
                                     lesson.currentSentence)]],
                lesson)
   ...
   var gradeSentence = F2(function (sentence,
   time) {
      return A3($List.foldr,
      F2(function (cm,tuple) {
         return cm.selected ? $Maybe.Just({ctor: "_Tuple2"
                                          ,_0: cm.chinese
                                          ,_1: {_: {}
                                               ,correct: _U.eq($CharacterModel.grade(cm),
                                               $CharacterModel.Correct)
                                               ,date: $Date.fromTime(time)}}) : tuple;
      }),
      $Maybe.Nothing,
      sentence);
   });
   var addAnswerToSentence = function (sentence) {
      return A2($List.map,
      function (cm) {
         return cm.selected ? function () {
            var _v9 = cm.currentAnswer;
            switch (_v9.ctor)
            {case "Just":
               return _U.replace([["answers"
                                  ,A2($List._op["::"],
                                  _v9._0,
                                  cm.answers)]
                                 ,["currentAnswer"
   ...
   var updateResults = F2(function (results,
   cr) {
      return function () {
         switch (cr.ctor)
         {case "Just":
            return function () {
                 var updateFunc = function (old) {
                    return function () {
                       switch (old.ctor)
                       {case "Just":
                          return $Maybe.Just(A2($List._op["::"],
                            ...
                            old._0));
                          case "Nothing":
                          return $Maybe.Just(_L.fromArray([$Basics.snd(cr._0)]));}
                       _U.badCase($moduleName,
                       "between lines 202 and 205");
                    }();
                 };
                 return _U.replace([["words"
                                    ,A3($Dict.update,
                                    $Basics.fst(cr._0),
                                    updateFunc,
                                    results.words)]],
            ...
            case "Nothing": return results;}
         _U.badCase($moduleName,
         "between lines 199 and 206");
      }();
   });
   var findNextLessonSentenceIndex = F3(function (lesson,
   results,
   now) {
      return function () {
         var nextIndex = A2($Basics._op["%"],
         lesson.currentSentenceIdx + 1,
         $List.length(lesson.sentences));
         var rotatedSentenceList = A2($Basics._op["++"],
         A2($List.drop,
         nextIndex,
         lesson.sentences),
         A2($List.take,
         nextIndex,
         lesson.sentences));
         var indexOffset = $Basics.fst(A3($List.foldl,
         F2(function (sentence,indexes) {
            return function () {
               switch (indexes.ctor)
               {case "_Tuple2":
                  switch (indexes._0)
                    {case -1:
                       return A3($Results.shouldReviewSentence,
                         $CharacterModel.sentenceModel(sentence),
                         results,
                         $Date.fromTime(now)) ? {ctor: "_Tuple2"
                                                ,_0: indexes._1
                                                ,_1: indexes._1 + 1} : {ctor: "_Tuple2"
                                                                       ,_0: -1
                                                                       ,_1: indexes._1 + 1};}
                    return indexes;}
               _U.badCase($moduleName,
         ...
         rotatedSentenceList));
         var nextValidIndex = indexOffset + nextIndex;
         return _U.eq(nextValidIndex,
         -1) ? nextIndex : nextValidIndex;
      }();
   });
   var isCorrect = function (cr) {
      return function () {
         switch (cr.ctor)
         {case "Just":
            switch (cr._0.ctor)
              {case "_Tuple2":
                 return cr._0._1.correct;}
              break;
            case "Nothing": return false;}
         _U.badCase($moduleName,
   ...
   var alreadyAnswered = function (sentence) {
      return function () {
         var _v22 = $List.head(A2($List.filter,
         function (x) {
            return x.selected;
         },
         sentence));
         switch (_v22.ctor)
         {case "Just":
            return _U.cmp($List.length(_v22._0.answers),
              1) > 0;
   ...
   var selectFirst = function (l) {
      return function () {
         var _v24 = $List.head(l);
         switch (_v24.ctor)
         {case "Just":
            return A2($List._op["::"],
              _U.replace([["selected",true]],
              _v24._0),
              $ListUtils.forceTail(l));
            case "Nothing": return l;}
         _U.badCase($moduleName,
         "between lines 59 and 61");
      }();
   };
   var updateLesson = F2(function (i,
   l) {
      return function () {
         var selectedSentence = $List.head(A2($List.drop,
         i,
         l.sentences));
         var cs = function () {
            switch (selectedSentence.ctor)
            {case "Just":
               return $Maybe.Just(selectFirst($CharacterModel.sentenceModel(selectedSentence._0)));
               case "Nothing":
               return $Maybe.Nothing;}
            _U.badCase($moduleName,
            "between lines 66 and 69");
         }();
         return _U.replace([["currentSentence"
                            ,cs]
                           ,["currentSentenceIdx",i]],
         l);
      }();
   });
   var moveToNextCharacter = F3(function (lesson,
   results,
   now) {
      return function () {
         var _v28 = lesson.currentSentence;
         switch (_v28.ctor)
         {case "Just":
            return function () {
                 var selectedIndex = A3($List.foldr,
                 F2(function (c,i) {
                    return $Basics.snd(c).selected ? $Basics.fst(c) : i;
                 }),
                 $List.length(_v28._0),
                 A2($List.indexedMap,
                 F2(function (v0,v1) {
                 ...
                 _v28._0));
                 var deselectedSegment = A2($List.map,
                 function (x) {
                 ...
                 selectedIndex + 1,
                 _v28._0));
                 var selectedSegment = $Basics.snd(A3($List.foldl,
                 F2(function (cm,n) {
                    return function () {
                       var hasPinyin = function () {
                          var _v30 = cm.pinyin;
                          switch (_v30.ctor)
                          {case "Just": return true;
                             case "Nothing": return false;}
                       ...
                       var soFar = $Basics.snd(n);
                       var beenSelected = $Basics.fst(n);
                       return $Basics.not(beenSelected) && hasPinyin ? {ctor: "_Tuple2"
                                                                       ,_0: true
                                                                       ,_1: A2($Basics._op["++"],
                                                                       soFar,
                                                                       _L.fromArray([_U.replace([["selected"
                                                                                                 ,true]],
                                                                       cm)]))} : {ctor: "_Tuple2"
                                                                                 ,_0: beenSelected
                                                                                 ,_1: A2($Basics._op["++"],
                 ...
                 selectedIndex + 1,
                 _v28._0)));
                 var fullSentence = A2($Basics._op["++"],
                 deselectedSegment,
                 selectedSegment);
                 ...
                 fullSentence))) ? _U.replace([["currentSentence"
                                               ,$Maybe.Just(fullSentence)]],
                 lesson) : A2(updateLesson,
                 A3(findNextLessonSentenceIndex,
                 lesson,
                 results,
                 now),
                 lesson);
              }();
            case "Nothing": return lesson;}
         _U.badCase($moduleName,
         "between lines 153 and 177");
      }();
   });
   var tryToMoveToNextCharacter = F2(function (model,
   time) {
      return function () {
         var _v32 = model.lesson.currentSentence;
         switch (_v32.ctor)
         {case "Just":
            return function () {
                 var currentSentenceWithAnswer = addAnswerToSentence(_v32._0);
                 var characterResult = A2(gradeSentence,
                 currentSentenceWithAnswer,
                 time);
                 var results = model.results;
                 var updatedResults = $Basics.not(alreadyAnswered(currentSentenceWithAnswer)) ? A2(updateResults,
                 results,
                 characterResult) : results;
                 var lesson = model.lesson;
                 var lessonWithAnswer = _U.replace([["currentSentence"
                                                    ,$Maybe.Just(currentSentenceWithAnswer)]],
                 lesson);
                 var updatedLesson = isCorrect(characterResult) ? A3(moveToNextCharacter,
                 lessonWithAnswer,
                 updatedResults,
                 time) : lessonWithAnswer;
                 return _U.replace([["lesson"
                                    ,updatedLesson]
   ...
   var DimensionChange = function (a) {
      return {ctor: "DimensionChange"
             ,_0: a};
   };
   ...
   var transformStorageToAction = function (r) {
      return function () {
         switch (r.ctor)
         {case "Just":
            return $Task.succeed(LoadResults(r._0));
            case "Nothing":
            return $Task.succeed(LoadResults({_: {}
                                             ,words: $Dict.empty}));}
         _U.badCase($moduleName,
         "between lines 87 and 89");
      }();
   };
   var initResults = A2($Task.andThen,
   A2($LocalStorage.getJson,
   $Results.resultsDecoder,
   "results"),
   transformStorageToAction);
   var NextCharacter = {ctor: "NextCharacter"};
   var NextSentence = {ctor: "NextSentence"};
   var NoAction = {ctor: "NoAction"};
   var transformSaveToAction = function (s) {
      return $Task.succeed(NoAction);
   };
   var saveResults = function (r) {
      return A2($Task.andThen,
      A2($LocalStorage.set,
      "results",
      $Results.resultsToString(r)),
      transformSaveToAction);
   };
   var InputPinyin = function (a) {
      return {ctor: "InputPinyin"
             ,_0: a};
   };
   var inputView = F2(function (address,
   model) {
      return function () {
         var currentAnswer = function () {
            var _v36 = A2($ListUtils.find,
            function (x) {
               return x.selected;
            },
            model);
            ...
            {case "Just":
               return function () {
                    var _v38 = _v36._0.currentAnswer;
                    switch (_v38.ctor)
                    {case "Just": return _v38._0;
                       case "Nothing": return "";}
                    _U.badCase($moduleName,
                    "between lines 311 and 314");
                 }();
               case "Nothing":
               return "not found";}
            _U.badCase($moduleName,
            "between lines 309 and 314");
         }();
         var enterHandler = A2($Html$Events.onKeyDown,
         address,
         function (i) {
            return _U.eq(i,
            13) ? NextCharacter : NoAction;
         });
         var changeHandler = A3($Html$Events.on,
         "input",
         ...
         function (str) {
            ...
            A2($Regex.contains,
            $Regex.regex(" $"),
            str) ? NextCharacter : InputPinyin(str));
         });
         return A2($Html.input,
         _L.fromArray([changeHandler
                      ,enterHandler
                      ,$Html$Attributes.autofocus(true)
                      ,$Html$Attributes.value(currentAnswer)]),
         _L.fromArray([]));
      }();
   });
   ...
   model) {
      return function () {
         var _v40 = model.loadState;
         switch (_v40.ctor)
         {case "Loaded":
            return function () {
                 var _v41 = model.lesson.currentSentence;
                 switch (_v41.ctor)
                 {case "Just":
                    return A2($Html.div,
                      _L.fromArray([]),
                      _L.fromArray([A2(sentenceView,
                                   address,
                                   _v41._0)
                                   ,A2(inputView,
                                   address,
                                   _v41._0)]));
                    case "Nothing":
                    return $Html.text("Invalid sentence");}
                 _U.badCase($moduleName,
   ...
   var update = F4(function (loopback,
   t,
   action,
   model) {
      return function () {
         var _v43 = model.loadState;
         switch (_v43.ctor)
         {case "Loaded":
            return function () {
                 switch (action.ctor)
                 {case "InputPinyin":
                    return {ctor: "_Tuple2"
                           ,_0: A2(updateInputPinyin,
                           action._0,
                           model)
                           ,_1: $Maybe.Nothing};
                    case "NextCharacter":
                    return function () {
                         var newModel = A2(tryToMoveToNextCharacter,
                         model,
                         t);
                         return {ctor: "_Tuple2"
                                ,_0: newModel
                                ,_1: $Maybe.Just(loopback(saveResults(newModel.results)))};
                      }();}
                 return {ctor: "_Tuple2"
                        ,_0: model
                        ,_1: $Maybe.Nothing};
            ...
            return function () {
                 ...
                 {case "LoadResults":
                    return function () {
                         var lesson = model.lesson;
                         return {ctor: "_Tuple2"
                                ,_0: _U.replace([["loadState"
                                                 ,Loaded]
                                                ,["results",action._0]
                                                ,["lesson"
                                                 ,A2(updateLesson,
                                                 A3(findNextLessonSentenceIndex,
                                                 _U.replace([["currentSentenceIdx"
                                                             ,-1]],
                                                 lesson),
                                                 action._0,
                                                 t),
            ...
            return {ctor: "_Tuple2"
                   ,_0: _U.replace([["loadState"
                                   ...
                                   ,["now",t]],
                   model)
                   ,_1: $Maybe.Just(loopback(initResults))};}
         _U.badCase($moduleName,
   ...
   var init = {_: {}
              ...
              0,
              {_: {}
              ,currentSentence: $Maybe.Nothing
              ,currentSentenceIdx: 0
              ,sentences: A2($List.map,
              $CharacterModel.workbookProblemToSentence,
              $WorkbookProblems.workbookProblems)})
              ,loadState: NotLoaded
              ,now: 0
              ,results: {_: {}
                        ,words: $Dict.empty}};
   var AppModel = F4(function (a,
   b,
   c,
   d) {
      return {_: {}
   ...
   var Lesson = F3(function (a,
   b,
   c) {
      return {_: {}
             ,currentSentence: b
             ,currentSentenceIdx: c
             ,sentences: a};
   });
   var externalActions = A2($Signal.map,
   function (x) {
      return DimensionChange(x);
   },
   $Window.dimensions);
   var viewsAndTasks = A2($StartApp.start,
   {_: {}
   ,initialState: init
   ,update: update
   ,view: view},
   ...
   $Basics.snd(viewsAndTasks));
   var main = $Basics.fst(viewsAndTasks);
   _elm.PinyinApp.values = {_op: _op
                           ,main: main
                           ,externalActions: externalActions
                           ,viewsAndTasks: viewsAndTasks
                           ,Lesson: Lesson
                           ,AppModel: AppModel
                           ,NotLoaded: NotLoaded
                           ,Loading: Loading
                           ...
                           ,init: init
                           ,transformStorageToAction: transformStorageToAction
                           ,initResults: initResults
                           ,update: update
                           ,saveResults: saveResults
                           ,transformSaveToAction: transformSaveToAction
                           ,tryToMoveToNextCharacter: tryToMoveToNextCharacter
                           ,alreadyAnswered: alreadyAnswered
                           ,isCorrect: isCorrect
                           ,moveToNextCharacter: moveToNextCharacter
                           ,findNextLessonSentenceIndex: findNextLessonSentenceIndex
                           ,updateResults: updateResults
                           ,addAnswerToSentence: addAnswerToSentence
                           ,gradeSentence: gradeSentence
                           ,updateInputPinyin: updateInputPinyin
                           ,updateInput: updateInput
                           ,updateCurrentSentence: updateCurrentSentence
                           ,view: view
                           ,debugView: debugView
...
Elm.Results.make = function (_elm) {
   ...
   if (_elm.Results.values)
   return _elm.Results.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $Time = Elm.Time.make(_elm);
   var foldCharacterResults = F2(function (cr,
   currentTpl) {
      return function () {
         switch (currentTpl.ctor)
         {case "_Tuple4":
            switch (currentTpl._0.ctor)
              {case "Just":
                 switch (currentTpl._1.ctor)
                   {case "Just":
                      switch (currentTpl._3)
                        {case false:
                           return cr.correct ? {ctor: "_Tuple4"
                                               ,_0: $Maybe.Just(cr.date)
                                               ,_1: $Maybe.Just(currentTpl._1._0)
                                               ,_2: currentTpl._2 + 1
                                               ,_3: false} : {ctor: "_Tuple4"
                                                             ,_0: $Maybe.Just(currentTpl._0._0)
                                                             ,_1: $Maybe.Just(currentTpl._1._0)
                                                             ,_2: currentTpl._2
                                                             ,_3: true};}
                        break;}
   ...
   var thd = function (v) {
      return function () {
         switch (v.ctor)
         {case "_Tuple4": return v._2;}
         _U.badCase($moduleName,
         "between lines 47 and 48");
      }();
   };
   var characterResultsToString = function (cr) {
      return $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                               ,_0: "date"
                                               ,_1: $Json$Encode.$float($Date.toTime(cr.date))}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "correct"
                                               ,_1: $Json$Encode.bool(cr.correct)}]));
   };
   var resultsToString = function (results) {
      return function () {
         var words = $Json$Encode.object(A2($List.map,
         function (x) {
            return {ctor: "_Tuple2"
                   ,_0: $Basics.fst(x)
                   ,_1: $Json$Encode.list(A2($List.map,
                   characterResultsToString,
                   $Basics.snd(x)))};
         },
         $Dict.toList(results.words)));
         var fullResult = $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                                            ,_0: "words"
                                                            ,_1: words}]));
   ...
   var CharacterResult = F2(function (a,
   b) {
      return {_: {}
             ,correct: b
             ,date: a};
   });
   var ReviewInThirtyDays = {ctor: "ReviewInThirtyDays"};
   var ReviewInOneWeek = {ctor: "ReviewInOneWeek"};
   var ReviewInThreeDays = {ctor: "ReviewInThreeDays"};
   var ReviewInOneDay = {ctor: "ReviewInOneDay"};
   var ReviewNow = {ctor: "ReviewNow"};
   var NotSeen = {ctor: "NotSeen"};
   var determineReviewGroupByHanzi = F2(function (c,
   results) {
      return function () {
         var _v12 = A2($Dict.get,
         c,
         results.words);
         switch (_v12.ctor)
         {case "Just":
            return function () {
                 var dateRangeAndCountTpl = A3($List.foldr,
                 ...
                 _v12._0));
                 return function () {
                    switch (dateRangeAndCountTpl.ctor)
                    {case "_Tuple4":
                       switch (dateRangeAndCountTpl._0.ctor)
                         {case "Just":
                            switch (dateRangeAndCountTpl._1.ctor)
                              {case "Just":
                                 return function () {
                                      var timeDifference = $Date.toTime(dateRangeAndCountTpl._1._0) - $Date.toTime(dateRangeAndCountTpl._0._0);
                                      var reviewGroup = _U.cmp(timeDifference,
                                      day) < 0 || _U.cmp(dateRangeAndCountTpl._2,
                                      1) < 1 ? ReviewInOneDay : _U.cmp(timeDifference,
                                      3 * day) < 0 || _U.cmp(dateRangeAndCountTpl._2,
                                      2) < 1 ? ReviewInThreeDays : _U.cmp(timeDifference,
                                      7 * day) < 0 || _U.cmp(dateRangeAndCountTpl._2,
                                      3) < 1 ? ReviewInOneWeek : ReviewInThirtyDays;
                                      return {ctor: "_Tuple2"
                                             ,_0: $Maybe.Just(dateRangeAndCountTpl._1._0)
                                             ,_1: reviewGroup};
                                   }();}
                              break;
                            case "Nothing":
            ...
            return {ctor: "_Tuple2"
                   ...
                   ,_1: NotSeen};}
         _U.badCase($moduleName,
         "between lines 70 and 86");
      }();
   });
   var determineDateToReviewHanzi = F2(function (c,
   results) {
      return function () {
         var _v21 = A2(determineReviewGroupByHanzi,
         c,
         results);
         switch (_v21.ctor)
         {case "_Tuple2":
              ...
              {case "Just":
                 return function () {
                      var days = function () {
                         ...
                         {case "ReviewInOneDay":
                            return day;
                            case "ReviewInOneWeek":
                            return day * 7;
                            case "ReviewInThirtyDays":
                            return day * 30;
                      ...
                      return $Maybe.Just($Date.fromTime($Date.toTime(_v21._0._0) + days));
                   }();
                 case "Nothing":
                 return $Maybe.Nothing;}
              break;}
   ...
   var foldDatesForReview = F3(function (results,
   cm,
   md) {
      return function () {
         switch (md.ctor)
         {case "Just":
            return function () {
                 ...
                 {case "Just":
                    return function () {
                         var _v30 = A2(determineDateToReviewHanzi,
                         cm.chinese,
                         results);
                         switch (_v30.ctor)
                         {case "Just":
                            return $Maybe.Just($Date.fromTime(A2($Basics.min,
                              $Date.toTime(md._0),
                              $Date.toTime(_v30._0))));
                            case "Nothing":
                            return $Maybe.Nothing;}
   ...
   var determineDateToReviewSentence = F2(function (sentence,
   results) {
      return A3($List.foldr,
      foldDatesForReview(results),
      $Maybe.Just($Date.fromTime(day * 365 * 10000)),
      sentence);
   });
   var shouldReviewSentence = F3(function (sentence,
   results,
   now) {
      return function () {
         var _v32 = A2(determineDateToReviewSentence,
         sentence,
         results);
         switch (_v32.ctor)
         {case "Just":
            return _U.cmp($Date.toTime(_v32._0),
              $Date.toTime(now)) < 1;
            case "Nothing": return true;}
         _U.badCase($moduleName,
   ...
   var resultsDecoder = function () {
      var characterResults = A3($Json$Decode.object2,
      CharacterResult,
      ...
      $Json$Decode.$float),
      function (v) {
         return $Result.Ok($Date.fromTime(v));
      }),
      A2($Json$Decode._op[":="],
      "correct",
      $Json$Decode.bool));
      ...
      A2($Json$Decode._op[":="],
      "words",
      $Json$Decode.dict($Json$Decode.list(characterResults))));
   }();
   var resultsFromString = function (results) {
      return function () {
   ...
   _elm.Results.values = {_op: _op
                         ,resultsToString: resultsToString
                         ,resultsFromString: resultsFromString
                         ,resultsDecoder: resultsDecoder
                         ,determineDateToReviewHanzi: determineDateToReviewHanzi
                         ,shouldReviewSentence: shouldReviewSentence
                         ,Results: Results
...
Elm.StartApp.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm),
   $Time = Elm.Time.make(_elm);
   var start = F2(function (app,
   externalActions) {
      return function () {
         var actionsMailbox = $Signal.mailbox($Maybe.Nothing);
         var justWrapper = A2($Signal.forwardTo,
         actionsMailbox.address,
         $Maybe.Just);
         var allActions = $Time.timestamp(A2($Signal.merge,
         actionsMailbox.signal,
         A2($Signal.map,
         $Maybe.Just,
         externalActions)));
         var loopbackFun = function (actionTask) {
            return A2($Task.andThen,
            actionTask,
            $Signal.send(justWrapper));
         };
         var stateAndTask = A3($Signal.foldp,
         F2(function (_v0,_v1) {
            return function () {
               switch (_v1.ctor)
               {case "_Tuple2":
         ...
         ,_1: $Maybe.Nothing},
         allActions);
         var html = $Signal.map(app.view(justWrapper))($Signal.map($Basics.fst)(stateAndTask));
         var tasks = A2($Signal.filterMap,
         $Basics.snd,
         $Task.succeed({ctor: "_Tuple0"}))(stateAndTask);
         return {ctor: "_Tuple2"
                ,_0: html
                ,_1: tasks};
      }();
...
Elm.WorkbookProblems = Elm.WorkbookProblems || {};
Elm.WorkbookProblems.make = function (_elm) {
   "use strict";
   _elm.WorkbookProblems = _elm.WorkbookProblems || {};
   if (_elm.WorkbookProblems.values)
   return _elm.WorkbookProblems.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "WorkbookProblems",
   $Basics = Elm.Basics.make(_elm),
   $CharacterModel = Elm.CharacterModel.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var workbookProblems = function () {
      var _v0 = A2($Json$Decode.decodeString,
      $CharacterModel.workbookDecoder,
      "[\n  {\n    \"chinese\": \"先生，您貴姓？\",\n    \"pinyin\": \"Xiānshēng, nín guìxìng?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他姓什麼？叫什麼名字？是哪國人？\",\n    \"pinyin\": \"Tā xìng shénme? Jiào shénme míngzì? Shì nǎ guórén?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我是中國人，你是美國人，她呢？\",\n    \"pinyin\": \"Wǒ shì zhōngguórén, nǐ shì měiguó rén, tā ne?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我姓王，不姓李，誰姓李？\",\n    \"pinyin\": \"Wǒ xìng wáng, bù xìng lǐ, shuí xìng lǐ?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"王先生，您好，您是英國人嗎？\",\n    \"pinyin\": \"Wáng xiānshēng, nín hǎo, nín shì yīngguó rén ma?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"您貴姓？\",\n    \"pinyin\": \"Nín guìxìng?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"王先生是哪國人？\",\n    \"pinyin\": \"Wáng xiānshēng shì nǎ guó rén?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"李先生好嗎？\",\n    \"pinyin\": \"Lǐ xiānshēng hǎo ma?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你叫什麼名字？\",\n    \"pinyin\": \"Nǐ jiào shénme míngzì?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他不是英國人，你呢？\",\n    \"pinyin\": \"Tā bùshì yīngguó rén, nǐ ne?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我是美國人，你呢？\",\n    \"pinyin\": \"Wǒ shì měiguó rén, nǐ ne?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"她是誰？\",\n    \"pinyin\": \"Tā shì shuí?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他姓什麼？\",\n    \"pinyin\": \"Tā xìng shénme?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"誰是中國人？\",\n    \"pinyin\": \"Shuí shì zhōngguó rén?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"您是美國人嗎？\",\n    \"pinyin\": \"Nín shì měiguó rén ma?\",\n    \"chapter\": 1,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"早，趙小姐，去上課啊？\",\n    \"pinyin\": \"Zǎo, zhào xiǎojiě, qù shàngkè a?\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"張太太，好久不見，您忙不忙？\",\n    \"pinyin\": \"Zhāng tàitài, hǎojiǔ bùjiàn, nín máng bù máng?\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"天氣很好，不冷也不熱。\",\n    \"pinyin\": \"Tiānqì hěn hǎo, bù lěng yě bù rè.\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"謝謝你們，再見。\",\n    \"pinyin\": \"Xièxiè nǐmen, zàijiàn.\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"找太太，這是什麼？\",\n    \"pinyin\": \"Zhǎo tàitài, zhè shì shénme?\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"好久不見，張小姐？\",\n    \"pinyin\": \"Hǎojiǔ bùjiàn, zhāng xiǎojiě?\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"早，趙先生，天氣好熱啊！\",\n    \"pinyin\": \"Zǎo, zhào xiānshēng, tiānqì hǎo rè a!\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你們去上課啊？\",\n    \"pinyin\": \"Nǐmen qù shàngkè a?\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我們也很忙。\",\n    \"pinyin\": \"Wǒmen yě hěn máng.\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"謝謝您，王小姐。\",\n    \"pinyin\": \"Xièxiè nín, wáng xiǎojiě.\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"這是張太太。\",\n    \"pinyin\": \"Zhè shì zhāng tàitài.\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我很忙，你呢？\",\n    \"pinyin\": \"Wǒ hěn máng, nǐ ne?\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"再見，趙小姐。\",\n    \"pinyin\": \"Zàijiàn, zhào xiǎojiě.\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他們去，我也去。\",\n    \"pinyin\": \"Tāmen qù, wǒ yě qù.\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"天氣很熱嗎？\",\n    \"pinyin\": \"Tiānqì hěn rè ma?\",\n    \"chapter\": 2,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"電影，電視，我都喜歡看。\",\n    \"pinyin\": \"Diànyǐng, diànshì, wǒ dū xǐhuān kàn.\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我沒有汽車，我要買日本車。\",\n    \"pinyin\": \"Wǒ méiyǒu qìchē, wǒ yāomǎi rìběn chē.\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"德文書報，我都不懂。\",\n    \"pinyin\": \"Dé wén shū bào, wǒ dū bù dǒng.\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"法國東西好看，可是貴。\",\n    \"pinyin\": \"Fàguó dōngxī hǎokàn, kěshì guì.\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他們有日本筆，你要看嗎？\",\n    \"pinyin\": \"Tāmen yǒu rìběn bǐ, nǐ yào kàn ma?\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他喜歡看書，不喜歡看電視。\",\n    \"pinyin\": \"Tā xǐhuān kànshū, bù xǐhuān kàn diànshì.\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"法國電影，我不懂。\",\n    \"pinyin\": \"Fàguó diànyǐng, wǒ bù dǒng.\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"日本汽車都好嗎？\",\n    \"pinyin\": \"Rìběn qìchē dōu hǎo ma?\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我沒有德國東西。\",\n    \"pinyin\": \"Wǒ méiyǒu déguó dōngxī.\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你要買中文報嗎？\",\n    \"pinyin\": \"Nǐ yāomǎi zhōngwén bào ma?\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我不懂英文。\",\n    \"pinyin\": \"Wǒ bù dǒng yīngwén.\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我有數，可是沒有筆。\",\n    \"pinyin\": \"Wǒ yǒushù, kěshì méiyǒu bǐ.\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我們都不看日本電影。\",\n    \"pinyin\": \"Wǒmen dōu bù kàn rìběn diànyǐng.\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"誰要買法國汽車？\",\n    \"pinyin\": \"Shuí yāomǎi fàguó qìchē?\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"德國碧軌，可是很好。\",\n    \"pinyin\": \"Déguó bì guǐ, kěshì hěn hǎo.\",\n    \"chapter\": 3,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"一，日，三，四，五，六，七，八，九，十，我一共有十個。\",\n    \"pinyin\": \"Yī, rì, sān, sì, wǔ, liù, qī, bā, jiǔ, shí, wǒ yīgòng yǒu shí gè.\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"請你給那位先生一杯咖啡。\",\n    \"pinyin\": \"Qǐng nǐ gěi nà wèi xiānshēng yībēi kāfēi.\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我有二十三塊零五分錢，你要多少？\",\n    \"pinyin\": \"Wǒ yǒu èrshísān kuài líng wǔ fēn qián, nǐ yào duōshǎo?\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"這種筆幾毛錢一枝。\",\n    \"pinyin\": \"Zhè zhǒng bǐ jǐ máo qián yīzhī.\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"請你找我兩錢半。\",\n    \"pinyin\": \"Qǐng nǐ zhǎo wǒ liǎng qián bàn.\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"這兩本書多少錢？\",\n    \"pinyin\": \"Zhè liǎng běnshū duōshǎo qián?\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"一枝筆五塊三毛五分錢。\",\n    \"pinyin\": \"Yīzhī bǐ wǔ kuài sān máo wǔ fēn qián.\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"三枝筆一共是六塊零五分錢。\",\n    \"pinyin\": \"Sānzhī bǐ yīgòng shì liù kuài líng wǔ fēn qián.\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"哪種東西貴不貴？\",\n    \"pinyin\": \"Nǎ zhǒng dōngxī guì bù guì?\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"請你也給我一杯，好不好？\",\n    \"pinyin\": \"Qǐng nǐ yě gěi wǒ yībēi, hǎobù hǎo?\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"哪個人要買多少本書？\",\n    \"pinyin\": \"Nǎge rén yāomǎi duōshǎo běnshū?\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"那四位先生都是美國人。\",\n    \"pinyin\": \"Nà sì wèi xiānshēng dōu shì měiguó rén.\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"請你找我二十八塊半。\",\n    \"pinyin\": \"Qǐng nǐ zhǎo wǒ èrshíbā kuài bàn.\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我沒有零錢。\",\n    \"pinyin\": \"Wǒ méiyǒu língqián.\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"三隻筆九塊錢，一枝筆幾塊錢？\",\n    \"pinyin\": \"Sān zhī bǐ jiǔ kuài qián, yīzhī bǐ jǐ kuài qián?\",\n    \"chapter\": 4,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我哥哥，姐姐，弟弟，妹妹都是學生。\",\n    \"pinyin\": \"Wǒ gēgē, jiějiě, dìdì, mèimei dōu shì xuéshēng.\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"王老師是你爸爸媽媽的朋友，對不對？\",\n    \"pinyin\": \"Wáng lǎoshī shì nǐ bàba māmā de péngyǒu, duì bùduì?\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我家有夠，也有貓。\",\n    \"pinyin\": \"Wǒjiā yǒu gòu, yěyǒu māo.\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"那些相片兒是你的還是她的？\",\n    \"pinyin\": \"Nàxiē xiàng piān er shì nǐ de háishì tā de?\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"李伯伯有兩個男孩子，沒有女兒。\",\n    \"pinyin\": \"Lǐ bóbo yǒu liǎng gè nán háizi, méiyǒu nǚ\'ér.\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"這是誰的像片兒？\",\n    \"pinyin\": \"Zhè shì shuí de xiàng piān er?\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我爸爸媽媽都是老師。\",\n    \"pinyin\": \"Wǒ bàba māmā dōu shì lǎoshī.\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你喜歡狗還是貓？\",\n    \"pinyin\": \"Nǐ xǐhuān gǒu háishì māo?\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我哥哥的女朋友很好看。\",\n    \"pinyin\": \"Wǒ gēgē de nǚ péngyǒu hěn hǎokàn.\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你沒有姐姐妹妹，對不對？\",\n    \"pinyin\": \"Nǐ méiyǒu jiějiě mèimei, duì bùduì?\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"那些東西都是我弟弟的。\",\n    \"pinyin\": \"Nàxiē dōngxī dū shì wǒ dìdì de.\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"有的學生有汽車。\",\n    \"pinyin\": \"Yǒu de xuéshēng yǒu qìchē.\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我朋友家有四個男孩子。\",\n    \"pinyin\": \"Wǒ péngyǒu jiā yǒu sì gè nán háizi.\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"張伯伯有一個兒子，兩個女兒。\",\n    \"pinyin\": \"Zhāng bóbo yǒu yīgè er zi, liǎng gè nǚ\'ér.\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"有的小孩子太喜歡看電視。\",\n    \"pinyin\": \"Yǒu de xiǎo háizi tài xǐhuān kàn diànshì.\",\n    \"chapter\": 5,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"請問，中國有十二億人，對不對？\",\n    \"pinyin\": \"Qǐngwèn, zhōngguó yǒu shí\'èr yì rén, duì bùduì?\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"這個照像幾日本貨，一萬塊錢，真不便宜。\",\n    \"pinyin\": \"Zhège zhào xiàng jǐ rìběn huò, yī wàn kuài qián, zhēn bù piányí.\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我知道那個學校只有八千學生。\",\n    \"pinyin\": \"Wǒ zhīdào nàgè xuéxiào zhǐyǒu bāqiān xuéshēng.\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我覺得我的車太舊也太小了，我想買大的新車。\",\n    \"pinyin\": \"Wǒ juédé wǒ de jū tài jiù yě tài xiǎole, wǒ xiǎng mǎi dà de xīnchē.\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我想買錶，五百塊錢夠不夠？\",\n    \"pinyin\": \"Wǒ xiǎng mǎi biǎo, wǔbǎi kuài qián gòu bùgòu?\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我想這個照像幾不便宜。\",\n    \"pinyin\": \"Wǒ xiǎng zhège zhào xiàng jī bù piányí.\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我不知道哪個學校有多少學生。\",\n    \"pinyin\": \"Wǒ bù zhīdào nǎge xuéxiào yǒu duōshǎo xuéshēng.\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"新車貴，舊車便宜。\",\n    \"pinyin\": \"Xīnchē guì, jiù chē piányí.\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"請問這是德國貨還是日本貨？\",\n    \"pinyin\": \"Qǐngwèn zhè shì déguó huò háishì rìběn huò?\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我覺得這本書真好。\",\n    \"pinyin\": \"Wǒ juédé zhè běnshū zhēn hǎo.\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"美國有兩億人，對不對？\",\n    \"pinyin\": \"Měiguó yǒu liǎng yì rén, duì bùduì?\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"太貴了，我的錢不夠。\",\n    \"pinyin\": \"Tài guìle, wǒ de qián bùgòu.\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"新的賣一萬塊錢，舊的只賣兩千塊。\",\n    \"pinyin\": \"Xīn de mài yī wàn kuài qián, jiù de zhǐ mài liǎng qiān kuài.\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我不知道那個是不是新的。\",\n    \"pinyin\": \"Wǒ bù zhīdào nàgè shì bùshì xīn de.\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"那個大錶只賣五百塊錢。\",\n    \"pinyin\": \"Nàgè dà biǎo zhǐ mài wǔbǎi kuài qián.\",\n    \"chapter\": 6,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他很能唸書，畫兒也畫很好，可是做事太慢。\",\n    \"pinyin\": \"Tā hěn néng niànshū, huà er yě huà hěn hǎo, kěshì zuòshì tài màn.\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"這鞋子有一點兒難寫，你現在可以教我嗎？\",\n    \"pinyin\": \"Zhè xiézi yǒu yīdiǎn er nán xiě, nǐ xiànzài kěyǐ jiào wǒ ma?\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我不唱歌兒，可是喜歡德歌兒。\",\n    \"pinyin\": \"Wǒ bù chànggē er, kěshì xǐhuān dé gē er.\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他喜歡吃菜，喝酒，不喜歡做飯。\",\n    \"pinyin\": \"Tā xǐhuān chī cài, hējiǔ, bù xǐhuān zuò fàn.\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他說話很快也很有意思。\",\n    \"pinyin\": \"Tā shuōhuà hěn kuài yě hěn yǒuyìsi.\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我會說一點兒中國話。\",\n    \"pinyin\": \"Wǒ huì shuō yīdiǎn er zhōngguó huà.\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"現在不可以唱歌兒。\",\n    \"pinyin\": \"Xiànzài bù kěyǐ chànggē er.\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"畫中國畫兒難，可是很有意思。\",\n    \"pinyin\": \"Huà zhōngguóhuà er nán, kěshì hěn yǒuyìsi.\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你能教我寫這寫字嗎？\",\n    \"pinyin\": \"Nǐ néng jiào wǒ xiě zhè xiě zì ma?\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他念書，也做事。\",\n    \"pinyin\": \"Tā niànshū, yě zuòshì.\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我不會做中國菜。\",\n    \"pinyin\": \"Wǒ bù huì zuò zhōngguó cài.\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"法國話好聽，法國酒也好喝。\",\n    \"pinyin\": \"Fàguó huà hǎotīng, fàguó jiǔ yě hǎo hē.\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他吃飯，吃得真慢。\",\n    \"pinyin\": \"Tā chīfàn, chī dé zhēn màn.\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"寫中國字很有意思。\",\n    \"pinyin\": \"Xiě zhōngguó zì hěn yǒuyìsi.\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他說話很快，我不都懂。\",\n    \"pinyin\": \"Tā shuōhuà hěn kuài, wǒ bù dōu dǒng.\",\n    \"chapter\": 7,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"因為他常常跳舞，所以他說跳舞容易。\",\n    \"pinyin\": \"Yīnwèi tā chángcháng tiàowǔ, suǒyǐ tā shuō tiàowǔ róngyì.\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你母親穿的這件衣服一定是外國貨。\",\n    \"pinyin\": \"Nǐ mǔqīn chuān de zhè jiàn yīfú yīdìng shì wàiguó huò.\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"噢，我知道，那位就是王老師。\",\n    \"pinyin\": \"Ō, wǒ zhīdào, nà wèi jiùshì wáng lǎoshī.\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"聽話他父親的書法不錯。\",\n    \"pinyin\": \"Tīnghuà tā fùqīn de shūfǎ bùcuò.\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我最愛喝茶，不愛喝水。\",\n    \"pinyin\": \"Wǒ zuì\'ài hē chá, bù ài hē shuǐ.\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你穿的這件衣服真好看。\",\n    \"pinyin\": \"Nǐ chuān de zhè jiàn yīfú zhēn hǎokàn.\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你常喝水嗎？\",\n    \"pinyin\": \"Nǐ cháng hē shuǐ ma?\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"因為她的外文不錯，所以她有很多外國朋友。\",\n    \"pinyin\": \"Yīnwèi tā de wàiwén bùcuò, suǒyǐ tā yǒu hěnduō wàiguó péngyǒu.\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他父親只愛喝茶。\",\n    \"pinyin\": \"Tā fùqīn zhǐ ài hē chá.\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"好聽的歌兒不一定容易唱。\",\n    \"pinyin\": \"Hǎotīng de gē er bu yīdìng róngyì chàng.\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他為什麼不愛跳舞？\",\n    \"pinyin\": \"Tā wèishéme bù ài tiàowǔ?\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"噢，您就是李先生啊？\",\n    \"pinyin\": \"Ō, nín jiùshì lǐ xiānshēng a?\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我覺得你穿的這件衣服不錯。\",\n    \"pinyin\": \"Wǒ juédé nǐ chuān de zhè jiàn yīfú bùcuò.\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"母親做的犯罪好吃。\",\n    \"pinyin\": \"Mǔqīn zuò de fànzuì hào chī.\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"聽說做生意不容易。\",\n    \"pinyin\": \"Tīng shuō zuò shēngyì bù róngyì.\",\n    \"chapter\": 8,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"可停在樓下，後面就是飯廳。\",\n    \"pinyin\": \"Kě tíng zài lóu xià, hòumiàn jiùshì fàntīng.\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你們學校的圖書館在什麼地方？\",\n    \"pinyin\": \"Nǐmen xuéxiào de túshū guǎn zài shénme dìfāng?\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"那家商店就在附近，離這所房子不遠。\",\n    \"pinyin\": \"Nà jiā shāngdiàn jiù zài fùjìn, lí zhè suǒ fángzi bù yuǎn.\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"孩子的椅子在那間屋子裡的桌子底下。\",\n    \"pinyin\": \"Háizi de yǐzi zài nà jiān wūzi lǐ de zhuōzi dǐxia.\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我的汽車就在前面路旁邊。\",\n    \"pinyin\": \"Wǒ de qìchē jiù zài qiánmiàn lù pángbiān.\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"圖書館離這兒不太員。\",\n    \"pinyin\": \"Túshū guǎn lí zhè\'er bù tài yuán.\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他家在哪個大樓後面。\",\n    \"pinyin\": \"Tā jiā zài nǎge dàlóu hòumiàn.\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"學校附近有很多商店。\",\n    \"pinyin\": \"Xuéxiào fùjìn yǒu hěnduō shāngdiàn.\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"孩子在飯廳的桌子底下做什麼？\",\n    \"pinyin\": \"Háizi zài fàntīng de zhuōzi dǐxia zuò shénme?\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我常在前面的飯館兒吃飯。\",\n    \"pinyin\": \"Wǒ cháng zài qiánmiàn de fànguǎn er chīfàn.\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"哪個地方離這兒很近很房邊。\",\n    \"pinyin\": \"Nǎ ge dìfāng lí zhè\'er hěn jìn hěn fáng biān.\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"那所房子，樓上樓下一共有七間屋子。\",\n    \"pinyin\": \"Nà suǒ fángzi, lóu shàng lóu xià yīgòng yǒu qī jiān wūzi.\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"客廳的桌子椅子都是新的。\",\n    \"pinyin\": \"Kètīng de zhuōzi yǐzi dōu shì xīn de.\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你們學校在什麼路？\",\n    \"pinyin\": \"Nǐmen xuéxiào zài shénme lù?\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我家就在學校旁邊。\",\n    \"pinyin\": \"Wǒjiā jiù zài xuéxiào pángbiān.\",\n    \"chapter\": 9,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他今天早上跟朋友坐飛機到日本去了。\",\n    \"pinyin\": \"Tā jīntiān zǎoshang gēn péngyǒu zuò fēijī dào rìběn qùle.\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你為甚麼走路去？公共汽車票不貴。\",\n    \"pinyin\": \"Nǐ wéishènme zǒulù qù? Gōnggòng qìchē piào bù guì.\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"聽說他已經坐船英國回來了，玩兒得怎麼樣？\",\n    \"pinyin\": \"Tīng shuō tā yǐjīng zuò chuán yīngguó huíláile, wán er dé zěnme yàng?\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我的昨天晚上坐火車來的，你的什麼時候來的？\",\n    \"pinyin\": \"Wǒ de zuótiān wǎnshàng zuò huǒchē lái de, nǐ de shénme shíhòu lái de?\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"明天下午我不想開車去，開車太累，停車的地方他不好找。\",\n    \"pinyin\": \"Míngtiān xiàwǔ wǒ bùxiǎng kāichē qù, kāichē tài lèi, tíngchē dì dìfāng tā bù hǎo zhǎo.\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"今天你是做公共汽車來的嗎？\",\n    \"pinyin\": \"Jīntiān nǐ shì zuò gōnggòng qìchē lái de ma?\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"昨天妳跟她們玩兒得怎麼樣？\",\n    \"pinyin\": \"Zuótiān nǎi gēn tāmen wán er dé zěnme yàng?\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我還沒吃晚飯呢。\",\n    \"pinyin\": \"Wǒ hái méi chī wǎnfàn ne.\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你坐飛機還是坐船到日本去？\",\n    \"pinyin\": \"Nǐ zuò fēijī háishì zuò chuán dào rìběn qù?\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"飛機票太貴，我開車去。\",\n    \"pinyin\": \"Fēijī piào tài guì, wǒ kāichē qù.\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他已經從中國回來了。\",\n    \"pinyin\": \"Tā yǐjīng cóng zhōngguó huíláile.\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你們怎麼去？走路去嗎？\",\n    \"pinyin\": \"Nǐmen zěnme qù? Zǒulù qù ma?\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"這裡不可以停車。\",\n    \"pinyin\": \"Zhèlǐ bù kěyǐ tíngchē.\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他們明天下午要到我這兒來玩。\",\n    \"pinyin\": \"Tāmen míngtiān xiàwǔ yào dào wǒ zhè\'er lái wán.\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我有的時候覺得很累。\",\n    \"pinyin\": \"Wǒ yǒu de shíhòu juédé hěn lèi.\",\n    \"chapter\": 10,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我每天夜裡差不多睡六個鐘頭的覺。\",\n    \"pinyin\": \"Wǒ měitiān yèlǐ chàbùduō shuì liù gè zhōngtóu de jué.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他在床上休息呢，我們等一會兒吧。\",\n    \"pinyin\": \"Tā zài chuángshàng xiūxí ne, wǒmen děng yīhuǐ\'er ba.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"現在差一刻三點，我們三點過五分去車站。\",\n    \"pinyin\": \"Xiànzài chà yīkè sān diǎn, wǒmen sān diǎnguò wǔ fēn qù chēzhàn.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我五點半下了班，在公司門口等你。\",\n    \"pinyin\": \"Wǒ wǔ diǎn bàn xiàle bān, zài gōngsī ménkǒu děng nǐ.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"沒問題，我跟別人先去買飛機票。\",\n    \"pinyin\": \"Méi wèntí, wǒ gēn biérén xiān qù mǎi fēijī piào.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你們公司幾點鐘下班？\",\n    \"pinyin\": \"Nǐmen gōngsī jǐ diǎn zhōng xiàbān?\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"沒問題，我開車開得很好。\",\n    \"pinyin\": \"Méi wèntí, wǒ kāichē kāi dé hěn hǎo.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我每天睡八個鐘頭的覺。\",\n    \"pinyin\": \"Wǒ měitiān shuì bā gè zhōngtóu de jué.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他跟別人一起去看電影了。\",\n    \"pinyin\": \"Tā gēn biérén yīqǐ qù kàn diànyǐngle.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我們在房間門口等他吧。\",\n    \"pinyin\": \"Wǒmen zài fángjiān ménkǒu děng tā ba.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"現在差一刻九點，我馬上就去。\",\n    \"pinyin\": \"Xiànzài chà yīkè jiǔ diǎn, wǒ mǎshàng jiù qù.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你太累了，休息一會兒吧。\",\n    \"pinyin\": \"Nǐ tài lèile, xiūxí yīhuǐ\'er ba.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"昨天夜裡我睡得不太好。\",\n    \"pinyin\": \"Zuótiān yèlǐ wǒ shuì dé bù tài hǎo.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我每天六點半起床。\",\n    \"pinyin\": \"Wǒ měitiān liù diǎn bàn qǐchuáng.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"他十二點過五分下課。\",\n    \"pinyin\": \"Tā shí\'èr diǎnguò wǔ fēn xiàkè.\",\n    \"chapter\": 11,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"今天春天雨下得太多了，怎麼辦？\",\n    \"pinyin\": \"Jīntiān chūntiān yǔ xià dé tài duōle, zěnme bàn?\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"冬天太冷，夏天太熱，秋天是風景最好的季節。\",\n    \"pinyin\": \"Dōngtiān tài lěng, xiàtiān tài rè, qiūtiān shì fēngjǐng zuì hǎo de jìjié.\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我聽說他剛從歐洲旅行回來。\",\n    \"pinyin\": \"Wǒ tīng shuō tā gāng cóng ōuzhōu lǚxíng huílái.\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我們十二月十號星期一考試。\",\n    \"pinyin\": \"Wǒmen shí\'èr yuè shí hào xīngqí yī kǎoshì.\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"別著急，那輛新車應該沒問題。\",\n    \"pinyin\": \"Bié zhāojí, nà liàng xīnchē yīnggāi méi wèntí.\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"下星期五是幾月幾號？\",\n    \"pinyin\": \"Xià xīngqíwǔ shì jǐ yuè jǐ hào?\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"每年夏天到歐洲去旅行的人最多。\",\n    \"pinyin\": \"Měinián xiàtiān dào ōuzhōu qù lǚxíng de rén zuìduō.\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"冬天太冷，你應該春天去。\",\n    \"pinyin\": \"Dōngtiān tài lěng, nǐ yīnggāi chūntiān qù.\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"明天要考試，所以他很著急。\",\n    \"pinyin\": \"Míngtiān yào kǎoshì, suǒyǐ tā hěn zhāojí.\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"秋天是我最喜歡的季節。\",\n    \"pinyin\": \"Qiūtiān shì wǒ zuì xǐhuān de jìjié.\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"這輛汽車是我剛買的。\",\n    \"pinyin\": \"Zhè liàng qìchē shì wǒ gāng mǎi de.\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"那兒的春天風景最美，也不常下雨。\",\n    \"pinyin\": \"Nà\'er de chūntiān fēngjǐng zuìměi, yě bù cháng xià yǔ.\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"下星期要考試，現在我應該去圖書館。\",\n    \"pinyin\": \"Xià xīngqí yào kǎoshì, xiànzài wǒ yīnggāi qù túshū guǎn.\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"我喜歡旅行，可是沒有錢，怎麼辦？\",\n    \"pinyin\": \"Wǒ xǐhuān lǚxíng, kěshì méiyǒu qián, zěnme bàn?\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"你在歐洲住了幾年？\",\n    \"pinyin\": \"Nǐ zài ōuzhōu zhùle jǐ nián?\",\n    \"chapter\": 12,\n    \"book\": 1\n  },\n  {\n    \"chinese\": \"下禮拜放假，我打算到鄉下去住幾天，可是汽車壞了。\",\n    \"pinyin\": \"Xià lǐbài fàngjià, wǒ dǎsuàn dào xiāngxiàqù zhù jǐ tiān, kěshì qìchē huàile.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"也許因為天氣不好，最近生病的人特別多，得小心。\",\n    \"pinyin\": \"Yěxǔ yīn wéi tiānqì bù hǎo, zuìjìn shēngbìng de rén tèbié duō, dé xiǎoxīn.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"他不舒服，醫生說是感冒，沒關係，不必吃藥。\",\n    \"pinyin\": \"Tā bú shūfú, yīshēng shuō shì gǎnmào, méiguānxì, bùbì chī yào.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"週末到山上去滑雪的人不少。\",\n    \"pinyin\": \"Zhōumò dào shān shàngqù huáxuě de rén bù shǎo.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"她可能忘了來考試，我真不放心。\",\n    \"pinyin\": \"Tā kěnéng wàngle lái kǎoshì, wǒ zhēn bù fàngxīn.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"最近我不太舒服，也許是因為天氣太壞。\",\n    \"pinyin\": \"Zuìjìn wǒ bù tài shūfú, yěxǔ shì yīn wéi tiānqì tài huài.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"今天放假，路上車多，開車得特別小心。\",\n    \"pinyin\": \"Jīntiān fàngjià, lùshàng chē duō, kāichē dé tèbié xiǎoxīn.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"沒關係，你不必去。\",\n    \"pinyin\": \"Méiguānxì, nǐ bùbì qù.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"這兩個禮拜我特別忙。\",\n    \"pinyin\": \"Zhè liǎng gè lǐbài wǒ tèbié máng.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"我的錶壞了，打算在買一個新的。\",\n    \"pinyin\": \"Wǒ de biǎo huàile, dǎsuàn zài mǎi yīgè xīn de.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"他也許得在鄉下住兩年。\",\n    \"pinyin\": \"Tā yěxǔ dé zài xiāng xià zhù liǎng nián.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"你生病了，應該去看醫生。\",\n    \"pinyin\": \"Nǐ shēngbìngle, yīnggāi qù kàn yīshēng.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"上個禮拜我感冒了，很不舒服。\",\n    \"pinyin\": \"Shàng gè lǐbài wǒ gǎnmàole, hěn bú shūfú.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"這個週末我打算到山上去滑雪。\",\n    \"pinyin\": \"Zhège zhōumò wǒ dǎsuàn dào shān shàngqù huáxuě.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"我忘了吃藥了。\",\n    \"pinyin\": \"Wǒ wàngle chī yàole.\",\n    \"chapter\": 1,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"往南一直走，到了第二個十字路口往右轉，就看見郵局了，在左邊。\",\n    \"pinyin\": \"Wǎng nán yīzhí zǒu, dàole dì èr gè shízìlù kǒu wǎng yòu zhuǎn, jiù kànjiàn yóujúle, zài zuǒbiān.\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"請別客氣，我可以先冰你忙，然後再去辦別的是。\",\n    \"pinyin\": \"Qǐng bié kèqì, wǒ kěyǐ xiān bīng nǐ máng, ránhòu zài qù bàn bié de shì.\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"我們是好離開台北，經過日本，再直飛美國西部的地方。\",\n    \"pinyin\": \"Wǒmen shì hǎo líkāi táiběi, jīngguò rìběn, zài zhí fēi měiguó xībù dì dìfāng.\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"枝條街的兩邊有很多高樓。\",\n    \"pinyin\": \"Zhītiáo jiē de liǎngbiān yǒu hěnduō gāo lóu.\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"美國東邊西邊都有海，最大的河在中部。\",\n    \"pinyin\": \"Měiguó dōngbian xībian dōu yǒu hǎi, zuìdà de hé zài zhōngbù.\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"要是你要我幫忙，請別客氣。\",\n    \"pinyin\": \"Yàoshi nǐ yào wǒ bāngmáng, qǐng bié kèqì.\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"中國有不少高山大河，東邊是海。\",\n    \"pinyin\": \"Zhōngguó yǒu bù shǎo gāoshān dàhé, dōngbian shì hǎi.\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"在那個十字路口不可以左轉。\",\n    \"pinyin\": \"Zài nàgè shízìlù kǒu bù kěyǐ zuǒ zhuǎn.\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"往前一直走，過兩條街，經過一家百貨公司，就到了。\",\n    \"pinyin\": \"Wǎng qián yīzhí zǒu,guò liǎng tiáo jiē, jīngguò yījiā bǎihuò gōngsī, jiù dàole.\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"到臺北的飛機幾點鐘起飛。\",\n    \"pinyin\": \"Dào táiběi de fēijī jǐ diǎn zhōng qǐfēi.\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"你先往南走，再往東走。\",\n    \"pinyin\": \"Nǐ xiān wǎng nán zǒu, zài wǎng dōng zǒu.\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"郵局就在學校旁邊。\",\n    \"pinyin\": \"Yóujú jiù zài xuéxiào pángbiān.\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"右邊第二所房子就是我家，你看見了嗎？\",\n    \"pinyin\": \"Yòubiān dì èr suǒ fángzi jiùshì wǒjiā, nǐ kànjiànle ma?\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"他打算離開城市到鄉下去住。\",\n    \"pinyin\": \"Tā dǎsuàn líkāi chéngshì dào xiāng xiàqù zhù.\",\n    \"chapter\": 2,\n    \"book\": 2\n  },\n  {\n    \"chinese\": \"哪條有名的和在中國南部。\",\n    \"pinyin\": \"Nǎ tiáo yǒumíng de hé zài zhōngguó nánbù.\",\n    \"chapter\": 2,\n    \"book\": 2\n  }\n]");
      switch (_v0.ctor)
      {case "Err":
         return _L.fromArray([]);
   ...
   _elm.WorkbookProblems.values = {_op: _op
                                  ,workbookProblems: workbookProblems};
   return _elm.WorkbookProblems.values;
};
